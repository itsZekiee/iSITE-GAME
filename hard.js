document.addEventListener('DOMContentLoaded', () => {
    ...
    const state = {
        ...
        totalTime: 0,
        loop: null,
        maxMoves: 15 // Example maxMoves value; adjust as needed
    };
    ...
    const displayLeaderboard = () => {
        const leaderboard = JSON.parse(localStorage.getItem('hardLeaderboard')) || [];
    ...
    const saveToLeaderboard = () => {
        ...
        localStorage.setItem('hardLeaderboard', JSON.stringify(leaderboard));
